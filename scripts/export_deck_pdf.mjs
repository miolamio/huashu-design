#!/usr/bin/env node
/**
 * export_deck_pdf.mjs — export a multi-file slide deck to one vector PDF
 *
 * Usage:
 ...
 *   - Backgrounds/graphics retain 1:1 fidelity via Playwright Chromium rendering.
 *   - No HTML modifications required.
 *   - Zero visual loss: the PDF is the browser print output.
 *
 * trade-off：
 *   - PDF text is not editable; edit the source HTML instead.
 *
