#!/usr/bin/env python3
"""
verify.py — Playwright wrapper for validating HTML design outputs

Usage:
    python verify.py path/to/design.html                    # Basic: open, screenshot, collect console errors
    python verify.py design.html --viewports 1920x1080,375x667  # Multiple viewports
    python verify.py deck.html --slides 10                  # Capture slides one by one (first 10)
...
def main():
    ...
    parser.add_argument("--slides", type=int, default=0,
                        help="Slide mode: capture the first N slides (HTML must support ArrowRight)")
    parser.add_argument("--output", default=None,
                        help="Output directory (default: screenshots/ next to the HTML file)")
    parser.add_argument("--show", action="store_true",
                        help="Non-headless mode: open a real browser window")
