 ...
 * - Sprite: time slice shown between start/end, with local progress
 ...
 *   </Stage>
 *
 * In Sprite children, use useSprite() to read current segment progress.
 */
...
(function() {
  ...
  const Easing = {
    ...
    // Fast start + slow braking gives numeric elements physical weight.
