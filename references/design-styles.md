...
> AI generation: ★★★ = strong direct output / ★★☆ = needs adjustment / ★☆☆ = HTML execution recommended
> Best path: AI Generation (direct image output) / HTML (code rendering, precise data) / Hybrid (HTML layout + AI-generated imagery)

**Core pattern**: styles with explicit visual elements such as illustration, particles, and generative art work well as direct AI output; styles that depend on precise typography and data, such as grids, information architecture, and whitespace, are more controllable through HTML rendering.

---

## 1. Information Architecture School (01-04)
...
**Key Traits**:
- Extremely restrained color: black and white plus one brand color
- A modern interpretation of the Swiss grid system
- Typography as the primary visual language
- Strategic use of negative space, with 60%+ whitespace
...
- Warm data-visualization tones: ochre, sage green, deep blue
- Interactive hierarchy systems
...
- Commitment to the traditional blue hyperlink
...
**Key Traits**:
- The rigor of scientific journals plus the elegance of design
- Precise visualization of quantitative data
- Calm professional palette: gray and navy
- Designed systems for annotations and citations
...
- Cinematic storyboard-like narrative
- Bold spatial whitespace
- Precisely choreographed dynamic elements
...
**Philosophy**: making technology visible makes technology understandable.
**Key Traits**:
...
- Balance between technical feeling and artistry
...
- Nonlinear exploration experience
...
## 3. Minimalist School (09-12)
> Philosophy: "Remove until nothing more can be removed."

### 09. Experimental Jetset - Conceptual Minimalism
**Philosophy**: one idea equals one form.
**Key Traits**:
- A single visual metaphor runs through the whole design
- Mondrian-like blue/red/yellow plus black and white
- Type as image
...
- Fusion of hand-made feeling and digital work
...
## 4. Experimental Vanguard (13-16)
> Philosophy: "Breaking rules creates rules."
...
**Philosophy**: the future is not cold; it is lonely poetry.
**Key Traits**:
...
**Key Traits**:
- Screen design for science-fiction films, also known as FUI
...
## 5. Eastern Philosophy School (17-20)
> Philosophy: "Whitespace is content."

### 17. Takram - Japanese Speculative Design
**Philosophy**: technology is a medium for thinking.
**Key Traits**:
- Elegant conceptual prototypes
- Soft technology feel: rounded corners and gentle shadows
- Charts as art
- Humble refinement
...
**Key Traits**:
- Digital interpretation of ink wash diffusion
- Soft glow effects
- Poetic whitespace
...
The key to AI image generation: short prompts outperform long prompts. Three sentences describing mood and content usually work better than 30 lines of layout detail.

| Diversity-killing phrasing | Creativity-triggering phrasing |
|----------------|----------------|
| Specify color ratios (60%/25%/15%) | Describe the mood ("warm like Sunday morning") |
| Mandate layout positions ("title centered, image on the right") | Reference specific aesthetics ("Pentagram editorial feel") |
| Restrict character poses and expressions | Let the AI interpret the style naturally |
| List every visual element to include | Describe what the audience should feel |

### Good / Bad Examples

**Bad — over-constrained, producing empty and flat AI output:**
```
...
**Good — mood-driven, producing more varied and tactile results:**
```
...
- **AI Generation**: styles with explicit visual elements, such as 06/07/12/13/14/15/16/20, can be produced directly with Gemini/Midjourney
- **HTML Rendering**: styles that depend on precise typography, such as 01/03/04/10/11/17/18, should use code to control data and layout
- **Hybrid**: HTML for the structural layout plus AI-generated imagery or backgrounds, such as 02/05/08/09/19

### Quality Control

1. ❌ Do not write "in the style of Pentagram" directly → ✅ Describe concrete design traits
2. Text often fails in AI generation → replace text after generation
3. Proportions distort easily → specify aspect ratio clearly
4. Generate 3-5 variants first, then refine the best one

**Default aesthetic no-go zones** (users may override based on their brand):
- ❌ Cyber neon / dark-blue background (#0D1117)
- ❌ Cover images with personal signatures or watermarks

---

**Version**: v2.1
**Updated**: 2026-02-13
**Applicable Scenarios**: all visual design use cases, including websites, PPT, PDF, infographics, covers, illustrations, apps, and more
**Integration with image-to-slides**: PPT scenarios may directly reference the styles in this file and execute generation through the image-to-slides skill
